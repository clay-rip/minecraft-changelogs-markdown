...
-   Entries stored in `minecraft:pot_decorations` component and minecraft:decorated;;_;;pot block entity are now full item stacks
...
-   [MC-91006](https://bugs.mojang.com/browse/MC-91006) - Some entities lose their name when placed/broken
-   [MC-102732](https://bugs.mojang.com/browse/MC-102732) - Arrows can visually bounce off of entities that don't wear a shield
...
-   [MC-122717](https://bugs.mojang.com/browse/MC-122717) - Command success messages for some commands include unaffected entities, unlike the command result
...
-   [MC-206356](https://bugs.mojang.com/browse/MC-206356) - The motion of falling block entities is visually slow
...
-   [MC-295756](https://bugs.mojang.com/browse/MC-295756) - Pistons desync on the client-side, causing players to be moved differently compared to other entities
-   [MC-297741](https://bugs.mojang.com/browse/MC-297741) - Gravity-affected blocks in upwards bubble columns can clip through solid blocks above them (on the client)
-   [MC-298431](https://bugs.mojang.com/browse/MC-298431) - Boats are launched by slime blocks inconsistently
-   [MC-298762](https://bugs.mojang.com/browse/MC-298762) - Phantoms deflect arrows shot from bows/crossbows
...
-   [MC-308830](https://bugs.mojang.com/browse/MC-308830) - Placing beds to replace tall grass doesn't break the other half
